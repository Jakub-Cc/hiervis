...
public final class MeasureTask implements Comparable<MeasureTask> {
	...
	/**
	 * Whether this measure should be computed automatically as soon as the
	 * hierarchy is loaded, if the measure is applicable to the hierarchy.
	 */
	public final boolean autoCompute;
	/**
	 * The function that returns a boolean value indicating whether the measure is
	 * applicable for the currently loaded hierarchy. This field is null if the
	 * measure is always applicable.
	 */
	...
	/**
	 * 
	 * @param measure                instance of the measure object itself
	 * @param identifier             Name of the computed measure. This will be
	 *                               displayed in the interface for the user to see.
	 * @param autoCompute            Whether this measure should be computed
	 *                               automatically as soon as the hierarchy is
	 *                               loaded, if the measure is applicable to the
	 *                               hierarchy
	 * @param applicabilityFunction2 The function that returns a boolean value
	 *                               indicating whether the measure is applicable
	 *                               for the currently loaded hierarchy. Null if the
	 *                               measure is always applicable.
	 * @param computeFunction        The function that will compute the measure
	 */
	public MeasureTask(Object measure, String identifier, boolean autoCompute,
			Function<Hierarchy, Boolean> applicabilityFunction2, Function<Hierarchy, Object> computeFunction) {
		...
		this.applicabilityFunction = applicabilityFunction2;
	...
	/**
	 * Calling this method when {@link #isQualityMeasure()} returns false will
