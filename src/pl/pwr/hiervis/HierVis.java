...
import pl.pwr.hiervis.ui.DockerUI;
import pl.pwr.hiervis.ui.VisualizerFrame;
import pl.pwr.hiervis.util.SwingUIUtils;

public final class HierVis {

	private static final Logger log = LogManager.getLogger(HierVis.class);
	...
	public static void main(String[] args) throws Exception {
		...
		if (cmd.hasOption('i')) {
			List<String> inputOptions = new ArrayList<>(Arrays.asList(cmd.getOptionValues('i')));
