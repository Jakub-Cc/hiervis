...
public class VisualizationState {
	...
	/**
	 * Updates this {@link VisualizationState} to represent the state of the
	 * specified display's visualization.
	 * 
	 * @param d the display whose visualization's state is to be stored
	 */
	public void store(Display d) {
		if (!(d instanceof HistogramGraph)) {
	 ...
	 * 
	 * @param d the display to apply the visualization state to
	 */
