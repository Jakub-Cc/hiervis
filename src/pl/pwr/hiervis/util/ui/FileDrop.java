...
public class FileDrop {
		...
		if (supportsDnD()) { // Make a drop listener
			dropListener = new java.awt.dnd.DropTargetListener() {
				public void dragEnter(DropTargetDragEvent evt) {
					dragEnter(out, c, dragBorder, evt);
				} // end dragEnter

				private void dragEnter(final java.io.PrintStream out, final java.awt.Component c,
						final javax.swing.border.Border dragBorder, java.awt.dnd.DropTargetDragEvent evt) {
	...
	private static File[] createFileArray(BufferedReader bReader, PrintStream out) {
		try {
			...
			while ((line = bReader.readLine()) != null) {
				conditionalAddLine(out, list, line);
			}
	...
	private static void conditionalAddLine(PrintStream out, java.util.List<java.io.File> list, java.lang.String line) {
		try {
	...
	public static class TransferableObject implements java.awt.datatransfer.Transferable {
		...
		public boolean isDataFlavorSupported(java.awt.datatransfer.DataFlavor flavor) {
			...
			return (flavor.equals(DATA_FLAVOR)) || (flavor.equals(java.awt.datatransfer.DataFlavor.stringFlavor));
