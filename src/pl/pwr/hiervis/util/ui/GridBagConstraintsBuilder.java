...
public class GridBagConstraintsBuilder {
    ...
    /**
     * Replaces the underlying {@link GridBagConstraints} with a new instance, and returns the
     * old one.
     * 
     * @return the {@link GridBagConstraints} with all the options that have been set thus
     *         far.
     */
    ...
    /**
     * Creates and sets new insets with the specified amount of pixels each horizontal
    ...
    /**
     * Creates and sets new insets with the specified amount of pixels each vertical direction
     * (top and bottom).
     * 
     * @see GridBagConstraints#insets
     */
