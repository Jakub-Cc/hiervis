...
public class ImageUtils {
	...
	public static BufferedImage rotate(BufferedImage img, double angle) {
		...
		g.translate((neww - w) / 2f, (newh - h) / 2f);
	...
	public static BufferedImage trimImg(BufferedImage img, Color backgroundColor) {
		// TODO instead of iterating through the columns of image, we can use BINARY
		...
		BufferedImage newImg = new BufferedImage(newWidth, imgHeight, BufferedImage.TYPE_INT_RGB);
	...
	public static BufferedImage addBorder(BufferedImage img, int leftWidth, int rightWidth, int topHeight,
			int bottomHeight, Color color) {
		BufferedImage borderedImg = new BufferedImage(img.getWidth() + leftWidth + rightWidth,
				img.getHeight() + topHeight + bottomHeight, img.getType());
