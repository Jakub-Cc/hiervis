...
public class BarGraph {
	...
	private static JFreeChart createChart(CategoryDataset dataset, Color backgroundColor, Color barColor) {
		...
		CategoryToolTipGenerator tooltipGenerator = (CategoryDataset categoryDataset, int series, int item) -> "#"
				+ (item + 1) + " " + categoryDataset.getColumnKey(item) + " (" + categoryDataset.getValue(series, item)
				+ ")";
