...
public class DimensionReductionnDialog<T extends DimensionReductionI> extends JDialog {
	...
	if (min > max)
	    throw new IllegalArgumentException(
		    "Minimum function for: (" + pointsAmount + ", " + inputDimensions + ") is bigger than maximum function.");
	if (value < min)
	    throw new IllegalArgumentException(
		    "default value function for: (" + pointsAmount + ", " + inputDimensions + ") is smaller than minimum function.");
	if (value > max)
	    throw new IllegalArgumentException(
		    "default value function for: (" + pointsAmount + ", " + inputDimensions + ") is bigger than maximum function.");
    }
