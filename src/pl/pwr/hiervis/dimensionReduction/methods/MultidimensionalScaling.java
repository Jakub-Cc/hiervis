...
public class MultidimensionalScaling extends FeatureExtraction {
	...
	double[][] output = generateDissimilarityMatrix(HierarchyUtils.toMatrix(source.getHierarchyWraper().getOriginalHierarchy()));
	...
	functionParameters.add(FunctionParameters.CreateFunctionParameter("Distance Measure",
		"Distance measure for calculation of disimilarity matrix", new ListType<DistanceMeasure>(list, enables)));

	functionParameters.add(FunctionParameters.CreateFunctionParameter("Minkowski p value", "Power value for Minkowski distance measure",
